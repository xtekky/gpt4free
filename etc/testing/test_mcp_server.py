...
async def test_mcp_server():
    ...
    init_request = MCPRequest(jsonrpc="2.0", id=1, method="initialize", params={})
    ...
    list_request = MCPRequest(jsonrpc="2.0", id=2, method="tools/list", params={})
    ...
    ping_request = MCPRequest(jsonrpc="2.0", id=3, method="ping", params={})
    ...
    list_request = MCPRequest(jsonrpc="2.0", id=5, method="tools/list", params={})
    response = await server.handle_request(list_request)
    for tool in response.result["tools"]:
