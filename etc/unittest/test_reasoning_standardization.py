...
class TestReasoningFieldStandardization(unittest.TestCase):
    def test_reasoning_object_structure(self):
        ...
        expected_dict = {"token": "thinking content", "status": "processing"}
    ...
    def test_openai_compatible_streaming_format(self):
        ...
        self.assertEqual(
            openai_format["choices"][0]["delta"]["reasoning"], "step by step reasoning"
        )
    ...
    def test_deepseek_compatible_format(self):
        ...
        self.assertEqual(
            deepseek_format["choices"][0]["delta"]["reasoning_content"],
    ...
    def test_proposed_standardization(self):
        ...
        self.assertEqual(
            proposed_format["choices"][0]["delta"]["reasoning"],
