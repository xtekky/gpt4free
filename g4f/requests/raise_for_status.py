...
def is_cloudflare(text: str) -> bool:
    if "Generated by cloudfront" in text or '<p id="cf-spinner-please-wait">' in text:
        ...
        "<title>Attention Required! | Cloudflare</title>" in text
        or 'id="cf-cloudflare-status"' in text
    ):
        return True
    return (
        '<div id="cf-please-wait">' in text or "<title>Just a moment...</title>" in text
    )
...
async def raise_for_status_async(
