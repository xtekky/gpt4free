...
from .Provider import (Aichat, Aivvm, ChatBase, ChatgptAi, ChatgptLogin, CodeLinkAva, BaseProvider, Bard, H2o, DeepAi,
                       Vercel, Vitalentum, Ylokh, You, Yqcloud)
...
class Model:
    name: str
    base_provider: str
    best_provider: Union[type[BaseProvider], list[type[BaseProvider]]]
